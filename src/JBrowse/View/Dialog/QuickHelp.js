    ...
    _makeDefaultContent: function() {
        return    ''
	        ...
	        + '<li>This sequence widget was built using the BioJs sequence viewer component. (http://biojs.net/jenkins/target/registry/Biojs.Sequence.html)</li>'
                ...
                + '<dd><ul>'
                + '<li>The 1001 Genomes variant track is color coded by variant type using <a target="_blank" href="http://plants.ensembl.org/info/genome/variation/predicted_data.html#consequence_type_table">Ensembl&#39;s consequence diagram</a>. The color legend is available on the track drop down menu.</li>'
	        + '<img src="plugins/EnsemblVariants/img/colorLegend.png" height="550px"><br />'
	        ...
	        + '<img src="plugins/EnsemblVariants/img/variantDisplay.png" height="450px"><br />'
	        + '<li>The track can be filtered by the consequence variation type.:</li>'
	        + '<img src="plugins/EnsemblVariants/img/majorGroupList.png" height="400px"><br />'
	        + '<li>Filtering the variant track by variant type:</li>'
	        + '<img src="plugins/EnsemblVariants/img/filterByType.png" height="400px"><br />'
	        ...
	        + '<img src="plugins/EnsemblVariants/img/variantFeatures.png" height="900px"><br />'
                + '</ul></dd>'
