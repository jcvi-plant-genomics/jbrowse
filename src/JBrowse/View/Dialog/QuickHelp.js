...
return declare( InfoDialog, {
    ...
    _makeDefaultContent: function() {
        return    ''
	        ...
	        + '<img src="img/seqlighter_image3.png" height="120px">'
	        ...
	        + '<img src="img/seqlighter_image8.png" height="300px">'
	        ...
	        + '<img src="img/seqlighter_image9.png" height="300px">'
	        + '<li>This sequence widget was built using the BioJs sequence viewer component. (http://biojs.net/jenkins/target/registry/Biojs.Sequence.html)</li>'
                ...
                + '<dd><ul>'
                + '<li>The 1001 Genomes variant track is color coded by variant type using <a target="_blank" href="http://plants.ensembl.org/info/genome/variation/predicted_data.html#consequence_type_table">Ensembl&#39;s consequence diagram</a>.</li>'
	        + '<img src="img/colorLegend.png" height="650px"><br />'
                + '<li>To view the variant feature dialogue box, right click a variant marker on the 1001 Genomes track and select "View Variation Feature from the menu.</li>'
	        + '<img src="img/variantDisplay.png" height="450px"><br />'
	        + '<li>Filtering the variant track by consequence type:</li>'
	        + '<img src="img/filterByConsequence.png" height="800px"><br />'
	        + '<li>Filtering the variant track by variant type:</li>'
	        + '<img src="img/filterByType.png" height="400px"><br />'
	        ...
	        + '<img src="img/variantFeatures.png" height="900px"><br />'
                + '</ul></dd>'
